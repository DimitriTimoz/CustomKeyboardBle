...
public:
  BleKeyboard(std::string deviceName = "ESP32 Keyboard", std::string deviceManufacturer = "Les déglingos", uint8_t batteryLevel = 100);
  void begin(void);
  void end(void);
  ...
  // to delete
  void printReport(KeyReport* report);
